...
String arrivalsFixture() =>
    File('../onebusaway/test/fixtures/arrivals_mts_24151.json')
        .readAsStringSync();

/// `currentTime` in the fixture: 2026-09-24T05:42:59.290Z (22:42 PDT).
final fixtureServerTime = DateTime.fromMillisecondsSinceEpoch(
  1790228579290,
  isUtc: true,
);

http.Response okResponse([String? body]) => http.Response(
  body ?? arrivalsFixture(),
  200,
